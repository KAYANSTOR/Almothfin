...
assert.equal(calculateAdvanceDeduction("w1", "2026-09", [{ id: "a1", workerId: "w1", amount: 1000, paidAmount: 250, date: "2026-08-01", note: "", deductionMethod: "automatic", status: "active" }]), 750);
